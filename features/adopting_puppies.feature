Feature: Adopting puppies
  ...
  Examples:
    ...
    | Ozzy  | 123 Main St    | ozzy@ozzy.com   | Credit card    |
    | Rob   | 345 Oak Ave    | rob@rob.com     | Check          |
    | Bruce | 549 Maple Lane | bruce@bruce.com | Purchase order |
  ...
  Scenario: Validate card with two puppies
    When I click the first View Details button
    And I click the Adopt Me button
    And I click the Adopt Another Puppy button
    And I click the second View Details button
